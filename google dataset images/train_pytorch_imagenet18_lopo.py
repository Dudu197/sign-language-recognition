...
validate_people = [int(sys.argv[1])]
test_people = [int(sys.argv[2])]
...
train_dataset = LopoDataset(df, frames, transform, transform_distance=False, person_out=validate_people + test_people, seed=seed)
